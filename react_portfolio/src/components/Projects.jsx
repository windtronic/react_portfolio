    ...
    <div className="project-container">
      <div className="project-card">
        ...
        <p>
          ...
          track their gardens. As the sole developer on this project, I was
          responsible for designing and implementing the entire application.
        ...
        <p>
          Technologies used: Django, Python, DBeaver, React.js, CSS,
          React-Big-Calendar, Material-UI, React Spring, React Gesture
        </p>
        <p>
          GitHub links:{" "}
          <a href="https://github.com/windtronic/garden_front_end">Frontend</a>{" "}
          | <a href="https://github.com/windtronic/garden_back_end">Backend</a>
        </p>
      </div>
      <div className="project-card">
        <a
        ...
        <p>Technologies used: Django, PostgreSQL, React.js, DBeaver, CSS</p>
        <p>
          GitHub links:{" "}
          <a href="https://github.com/windtronic/tickit_app_frontend">
            Frontend
          </a>{" "}
          |{" "}
          <a href="https://github.com/windtronic/tickit_app_backend">Backend</a>
        </p>
      </div>
      <div className="project-card">
        <a
        ...
        <p>
          Techn ologies used: PostgreSQL, Sequelize, Express / Node.js,
          React.js, CSS
        </p>
        <p>
          GitHub links:{" "}
          <a href="https://github.com/windtronic/pixidreams-front-end">
            Frontend
          </a>{" "}
          |{" "}
          <a href="https://github.com/windtronic/pixidreams-back-end">
            Backend
          </a>
        </p>
      </div>
      <div className="project-card">
        ...
        <p>Technologies used: Axios, React.js, JavaScript, HTML5, CSS</p>
        <p>
          GitHub link:{" "}
          <a href="https://github.com/windtronic/anime_search_database">Link</a>
        </p>
      </div>
    </div>
  );
